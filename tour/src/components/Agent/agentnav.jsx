...
import Postpackage from '../Agent/postpackage';
...
export default function AgentNav() {
  ...
  const [selectedPage, setSelectedPage] = React.useState('Package'); 
  ...
  return (
    <Box sx={{ display: 'flex' }}>
      <CssBaseline />
      <AppBar position="fixed" open={open} style={{backgroundColor:'#e7afb7'}}>
        <Toolbar>
          <IconButton
            color="inherit"
  ...
  <List style={{ backgroundColor: '#f8e7e9', flexGrow: 1 }}>
    ...
    <ListItem disablePadding sx={{ display: 'block' }}>
      ...
      >
        ...
        <ListItemText primary="Package" sx={{ opacity: open ? 1 : 0 }} />
      </ListItemButton>
    </ListItem>
    ...
    <ListItem disablePadding sx={{ display: 'block' }}>
      ...
      >
        ...
        <ListItemText primary="Hotel" sx={{ opacity: open ? 1 : 0 }} />
      </ListItemButton>
    </ListItem>
    ...
    <ListItem disablePadding sx={{ display: 'block' }}>
      <ListItemButton
        ...
        onClick={() => handleMenuItemClick('Restaurent')}    
      >
        <ListItemIcon sx={{ minWidth: 0, mr: open ? 3 : 'auto', justifyContent: 'center' }}>
          <RestaurantIcon />
        </ListItemIcon>
        <ListItemText primary="Restaurent" sx={{ opacity: open ? 1 : 0 }} />
      </ListItemButton>
    </ListItem>
    ...
    <ListItem disablePadding sx={{ display: 'block', flexGrow: 1, justifyContent: 'flex-end' }}>
      <ListItemButton
        ...
        onClick={() => handleMenuItemClick('Spot')}  
      >
        <ListItemIcon sx={{ minWidth: 0, mr: open ? 3 : 'auto', justifyContent: 'center' }}>
          <RoomIcon />
        </ListItemIcon>
  ...
  <List>
    ...
    <ListItem disablePadding sx={{ display: 'block' }}>
      ...
      <Box component="main" sx={{ flexGrow: 1, p: 3 }}>
        <DrawerHeader />
        {selectedPage === 'Package' && <Postpackage/>}
